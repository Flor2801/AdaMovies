...
const TopRatedMovies = () => {
  ...
  useEffect(() => {
    fetch(
      `https://api.themoviedb.org/3/movie/top_rated?api_key=8cd74c1ce651a04254aaab08ea9e9585&language=en-US&page=${paginaActual}`
    )
      .then((res) => res.json())
      .then((data) => {
  ...
  return (
    <>
     ...
     <SeccionGeneral>
      <h3>PELICULAS CON MEJORES CRITICAS</h3>
